...
- (void)startPlay {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"hideVideoBottomBar" object:nil];
...
- (void)restorePlay {
    ...
    if (self->_playerLayer) {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:@"showVideoBottomBar" object:nil];
